...
const StepScreen = ({ route }) => {
    ...
    return ( <
        ...
        <
        Text style = {
            { fontSize: 18, marginBottom: 20, fontWeight: 'bold' } } > { projectName } < /Text> <
        Text style = {
            { fontSize: 18, marginBottom: 20 } } > < Text style = {
            { fontWeight: 'bold' } } > Date: < /Text>{StepDate}</Text >

        <
        Text style = {
            { fontSize: 18, marginBottom: 5, fontWeight: 'bold' } } > Assignment Finished < /Text> <
        Switch style = {
            { marginBottom: 10 } }
        value = { formData.is_done }
        onValueChange = {
            (value) => setFormData({...formData, is_done: value }) }
        />

        <
        Text style = {
            { fontSize: 18, marginBottom: 5, fontWeight: 'bold' } } > Additional Comments: < /Text> <
        TextInput style = {
        ...
        <
        Text style = {
            { fontSize: 18, marginBottom: 20, fontWeight: 'bold', color: '#206422' } } > Save < /Text> <
        /TouchableOpacity>
